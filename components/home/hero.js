const Hero = () => {
    return (
        <section
            className="relative overflow-hidden bg-gradient-to-b mt-10 pb-12 sm:pb-16  lg:pb-24 xl:pb-32 xl:pt-20">
            <div className="relative z-20 mx-auto max-w-7xl lg:px-8">
                ...
                <div className="relative mx-auto mt-10 max-w-lg">
                    <img className="w-full rounded-2xl border border-gray-100 shadow" src="img/curriculum.jpg" alt="" />
                </div>
            </div>
        </section>
    );
